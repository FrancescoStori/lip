...
(* #### Exercise 3 *)
let%test "balanced_parentheses_1" = 
    derive balanced_parentheses [ 0; 7; 1; 7; 2; 7; 3] 
        |> to_string = "()[]{}"
let%test "balanced_parentheses_2" = 
    derive balanced_parentheses [ 0; 6; 3; 7; 1; 7; 3 ] 
        |> to_string = "({})[]"
let%test "balanced_parentheses_3" = 
    derive balanced_parentheses [ 0;6;1;7;1;6;3;4;3;7;3;7;3;7;3 ] 
        |> to_string = "({[][{}()]})"

(* #### Exercise 5 *)
let%test "zero_one_same_1" = 
    derive same_amount [ 0 ] 
    |> to_string = ""
let%test "zero_one_same_2" = 
    derive same_amount [ 2; 7; 4; 1; 5; 3; 0 ] 
    |> to_string = "1001"
let%test "zero_one_same_3" = 
    derive same_amount [ 1; 6; 1; 3; 5; 3; 1; 5; 3; 1; 5; 3; 0  ] 
    |> to_string = "00110101"
let%test "zero_one_same_4" = 
    derive same_amount [ 2; 7; 4; 1; 6; 1; 3; 5; 3; 2; 7; 4; 0 ] 
    |> to_string = "10001110"
